...
// --- Helper Data ---
const firstNames = ['Aarav', 'Vivaan', 'Aditya', 'Vihaan', 'Arjun', 'Sai', 'Reyansh', 'Ayaan', 'Krishna', 'Ishaan', 'Saanvi', 'Aanya', 'Aadhya', 'Aaradhya', 'Anika', 'Gauri', 'Pari', 'Ananya', 'Riya', 'Diya'];
const lastNames = ['Sharma', 'Verma', 'Gupta', 'Singh', 'Kumar', 'Patel', 'Reddy', 'Mehta', 'Jain', 'Khan'];
const mealTypes = ['Breakfast', 'Lunch', 'Dinner'];
const statuses = ['Active', 'Used'];
...
const seedCoupons = async () => {
    try {
        ...
        for (let i = 0; i < TOTAL_COUPONS_TO_CREATE; i++) {
            ...
            if (new Date(mealDate) < new Date(new Date().toISOString().slice(0,10))) {
                status = 'Expired';
            }
        ...
        await sequelize.query('ALTER TABLE PurchasedCoupons AUTO_INCREMENT = 100000000;');
