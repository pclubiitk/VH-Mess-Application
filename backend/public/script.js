                        ...
                        ${coupons
                          .map(
                            ...
                            <td class="px-4 py-2 text-sm">
                                ${
                                  c.status === "Active"
                                    ? `<button onclick="handleMarkAsUsed('${c.id}')" class="font-medium text-indigo-600 hover:text-indigo-800">Mark Used</button><br/>`
                                    : ``
                                }${
                              c.paymentstatus === "Pending"
                                ? `<button onclick="handleMarkPayment('${c.id}')" class="font-medium text-blue-600 hover:text-blue-800">Verify Payment</button>`
...
document
  ...
  .addEventListener("click", exportCouponsAsCSV);
